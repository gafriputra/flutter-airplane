  ...
  Widget build(BuildContext context) {
    Widget bonusCard() {
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: kPrimaryColor.withOpacity(0.5), blurRadius: 50, offset: Offset(0, 10)),
          ],
        ),
        child: Column(
            ...
            Row(
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(image: DecorationImage(image: AssetImage('assets/icon_plane.png'))),
                ),
                Text(
                  'Pay',
    ...
    Widget subTile() {
      return Container(
        ...
        child: Text(
          'We giveyou early credut so that\nyou can buy a flight ticket',
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [bonusCard(), title(), subTile(), startButton()],
        ),
      ),
    );
  }
